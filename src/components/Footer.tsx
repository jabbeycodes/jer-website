      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://wa.me/233557449657" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#C9A96E] text-sm transition-colors">
                WhatsApp Inquiry
              </a>
        ...
        <div className="border-t border-[#1F1F1F] pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            ...
            <a href="https://wa.me/233557449657" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#C9A96E] text-xs transition-colors">WhatsApp</a>
