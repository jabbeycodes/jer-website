# CLAUDE.md — jer-website

Coding guidance for Claude Code when working on the Jirapa Executive Residence marketing site.

## Global Rules — apply to every task unless explicitly overridden
...
Next.js 14 static marketing site. Deployed to Vercel via GitHub Actions.
Auto-deploy triggers on push to main. Secrets: VERCEL_TOKEN, VERCEL_ORG_ID, VERCEL_PROJECT_ID.
